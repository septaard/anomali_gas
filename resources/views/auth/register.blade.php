...
<head>
    ...
    <title>Daftar — Anomali Gas</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .error-msg { color: var(--accent-rose); font-size: 12px; margin-top: 5px; }
    </style>
</head>
<body>
    <div class="auth-card">
        <div class="auth-header">
            <h1 class="auth-title">Daftar Pengelola</h1>
            <p class="auth-subtitle">Buat akun untuk mengelola stok Anomali Gas</p>
        </div>
